...
import { Clinic } from "../client/src/types/clinic";
  ...
  return (
    <div className="bg-black min-h-screen font-sans text-[#ffaa40]">
      <Head>
        ...
        <meta name="google-site-verification" content="C_Xp0Pw8OQYHqXCl2gRMGLJfAKK9dnL3YOH-44qUBIc" />
        <link rel="canonical" href="https://yagogo.vercel.app/" />
        <link rel="icon" href="/attached_assets/favicon.ico" />
      </Head>
            ...
            {!hasSearched ? (
              <div className="flex flex-col items-center justify-center">
                <div className="bg-[rgba(255,122,0,0.1)] p-6 rounded-full mb-6">
                  <img 
                    src={`/attached_assets/LOGO_UPDATED.png?v=${Date.now()}`} 
                    alt="牙GoGo Logo" 
                    className="h-16 w-16" 
                  />
                </div>
                ...
                <p className="text-[#94a3b8] max-w-xl mb-8 text-lg">
