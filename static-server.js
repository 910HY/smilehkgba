...
async function startStaticServer() {
  ...
  app.get('/api/clinics', (req, res) => {
    try {
      ...
      // 使用提供的2025深圳牙科診所數據
      let szFilePath = path.join(process.cwd(), 'attached_assets', 'fixed_dental_clinics.json');
  ...
  app.get('/api/sz-clinics', (req, res) => {
    try {
      ...
      // 使用提供的2025深圳牙科診所數據
      let filePath = path.join(process.cwd(), 'attached_assets', 'fixed_dental_clinics.json');
