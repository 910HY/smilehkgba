  ...
  app.get('/api/clinics', (req, res) => {
    try {
      ...
      if (!fs.existsSync(szFilePath)) {
        console.log('找不到enhanced_sz_clinics.json，嘗試其他備用文件');
        szFilePath = path.join(process.cwd(), 'attached_assets', 'shenzhen_dental_clinics_valid.json');
      }
      if (!fs.existsSync(szFilePath)) {
        console.log('找不到已知有效的診所數據，嘗試其他備用文件');
  ...
  app.get('/api/sz-clinics', (req, res) => {
    try {
      ...
      if (!fs.existsSync(filePath)) {
        console.log('找不到enhanced_sz_clinics.json，嘗試其他備用文件');
        filePath = path.join(process.cwd(), 'attached_assets', 'shenzhen_dental_clinics_valid.json');
      }
      if (!fs.existsSync(filePath)) {
        console.log('找不到有效的診所數據，嘗試其他備用文件');
